...
//Remove Melting Recipes
	...
	mods.tconstruct.Melting.removeRecipe(<liquid:gold>, <immersiveposts:metal_rods>);
	mods.tconstruct.Melting.removeRecipe(<liquid:copper>, <immersiveposts:metal_rods:1>);
	mods.tconstruct.Melting.removeRecipe(<liquid:lead>, <immersiveposts:metal_rods:2>);
	mods.tconstruct.Melting.removeRecipe(<liquid:silver>, <immersiveposts:metal_rods:3>);
	mods.tconstruct.Melting.removeRecipe(<liquid:nickel>, <immersiveposts:metal_rods:4>);
	mods.tconstruct.Melting.removeRecipe(<liquid:constantan>, <immersiveposts:metal_rods:5>);
	mods.tconstruct.Melting.removeRecipe(<liquid:electrum>, <immersiveposts:metal_rods:6>);
	mods.tconstruct.Melting.removeRecipe(<liquid:uranium>, <immersiveposts:metal_rods:7>);
	mods.tconstruct.Melting.removeRecipe(<liquid:copper>, <immersiveengineering:sheetmetal>);
	mods.tconstruct.Melting.removeRecipe(<liquid:aluminum>, <immersiveengineering:sheetmetal:1>);
	mods.tconstruct.Melting.removeRecipe(<liquid:lead>, <immersiveengineering:sheetmetal:2>);
	mods.tconstruct.Melting.removeRecipe(<liquid:silver>, <immersiveengineering:sheetmetal:3>);
	mods.tconstruct.Melting.removeRecipe(<liquid:nickel>, <immersiveengineering:sheetmetal:4>);
	mods.tconstruct.Melting.removeRecipe(<liquid:uranium>, <immersiveengineering:sheetmetal:5>);
	mods.tconstruct.Melting.removeRecipe(<liquid:constantan>, <immersiveengineering:sheetmetal:6>);
	mods.tconstruct.Melting.removeRecipe(<liquid:electrum>, <immersiveengineering:sheetmetal:7>);
	mods.tconstruct.Melting.removeRecipe(<liquid:steel>, <immersiveengineering:sheetmetal:8>);
	mods.tconstruct.Melting.removeRecipe(<liquid:iron>, <immersiveengineering:sheetmetal:9>);
	mods.tconstruct.Melting.removeRecipe(<liquid:gold>, <immersiveengineering:sheetmetal:10>);
	...
	mods.tconstruct.Melting.removeRecipe(<liquid:steel>, <minecraft:hopper>);
...
//Smeltery Fuel
	...
	mods.tconstruct.Fuel.registerFuel(<liquid:napalm>, 70);


	//Gasoline smeltery temperature
	...
	mods.tconstruct.Fuel.registerFuel(<liquid:gasoline>, 90);
...
//TFC Metals to Smeltery
	...
	mods.tconstruct.Melting.addRecipe(<liquid:invar> * 144, <ore:scrapInvar>, 1450);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:alubrass> * 144, <ore:scrapAluminiumBrass>, 630);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:mithril> * 144, <ore:scrapMithril>, 940);
...
//	mods.tconstruct.Melting.addRecipe(<liquid:mithril> * 70, <ore:oreMithrilRich>, 940);
//	mods.tconstruct.Melting.addRecipe(<liquid:mithril> * 50, <ore:oreMithrilNormal>, 940);
//	mods.tconstruct.Melting.addRecipe(<liquid:mithril> * 30, <ore:oreMithrilPoor>, 940);
//	mods.tconstruct.Melting.addRecipe(<liquid:mithril> * 20, <ore:oreMithrilSmall>, 940);

	//Titanium

	mods.tconstruct.Melting.addRecipe(<liquid:titanium> * 2016, <tfc:metal/anvil/titanium>, 1700);
	mods.tconstruct.Melting.addRecipe(<liquid:titanium> * 144, <ore:scrapTitanium>, 1700);
...
//	mods.tconstruct.Melting.addRecipe(<liquid:titanium> * 70, <ore:oreTitaniumRich>, 1700);
//	mods.tconstruct.Melting.addRecipe(<liquid:titanium> * 50, <ore:oreTitaniumNormal>, 1700);
//	mods.tconstruct.Melting.addRecipe(<liquid:titanium> * 30, <ore:oreTitaniumPoor>, 1700);
//	mods.tconstruct.Melting.addRecipe(<liquid:titanium> * 20, <ore:oreTitaniumSmall>, 1700);

	//Osmium

	mods.tconstruct.Melting.addRecipe(<liquid:osmium> * 2016, <tfc:metal/anvil/osmium>, 3025);
	mods.tconstruct.Melting.addRecipe(<liquid:osmium> * 144, <ore:scrapOsmium>, 3025);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:antimony> * 144, <ore:scrapAntimony>, 630);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:tungsten_steel> * 144, <ore:scrapTungstenSteel>, 3695);
...
//	mods.tconstruct.Melting.addRecipe(<liquid:tungsten_steel> * 70, <ore:oreTungstenSteelRich>, 3695);
//	mods.tconstruct.Melting.addRecipe(<liquid:tungsten_steel> * 50, <ore:oreTungstenSteelNormal>, 3695);
//	mods.tconstruct.Melting.addRecipe(<liquid:tungsten_steel> * 30, <ore:oreTungstenSteelPoor>, 3695);
//	mods.tconstruct.Melting.addRecipe(<liquid:tungsten_steel> * 20, <ore:oreTungstenSteelSmall>, 3695);

	//Tungsten

	mods.tconstruct.Melting.addRecipe(<liquid:tungsten> * 2016, <tfc:metal/anvil/tungsten>, 3400);
	mods.tconstruct.Melting.addRecipe(<liquid:tungsten> * 144, <ore:scrapTungsten>, 3400);
	...
	//Uranium
	mods.tconstruct.Melting.addRecipe(<liquid:uranium> * 288, <immersiveengineering:sheetmetal:5>, 1132);

	//Constantan

	mods.tconstruct.Melting.addRecipe(<liquid:constantan> * 288, <immersiveengineering:sheetmetal:6>, 1200);
	mods.tconstruct.Melting.addRecipe(<liquid:constantan> * 144, <ore:scrapConstantan>, 1200);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:electrum> * 288, <immersiveengineering:sheetmetal:7>, 1200);
	mods.tconstruct.Melting.addRecipe(<liquid:electrum> * 144, <ore:scrapElectrum>, 1200);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:aluminum> * 288, <immersiveengineering:sheetmetal:1>, 660);
	mods.tconstruct.Melting.addRecipe(<liquid:aluminum> * 144, <ore:scrapAluminium>, 660);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:ardite> * 144, <ore:scrapArdite>, 1050);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:cobalt> * 144, <ore:scrapCobalt>, 1495);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:manyullyn> * 144, <ore:scrapManyullyn>, 1550);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:sterling_silver> * 144, <ore:scrapSterlingSilver>, 900);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:silver> * 288, <immersiveengineering:sheetmetal:3>, 961);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:silver> * 144, <ore:scrapSilver>, 961);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:lead> * 288, <immersiveengineering:sheetmetal:2>, 328);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:lead> * 144, <ore:scrapLead>, 328);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:nickel> * 288, <immersiveengineering:sheetmetal:4>, 1453);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:nickel> * 144, <ore:scrapNickel>, 1453);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:bronze> * 144, <ore:scrapBronze>, 950);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:tin> * 144, <ore:scrapTin>, 230);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:copper> * 288, <immersiveengineering:sheetmetal>, 1080);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:copper> * 144, <ore:scrapCopper>, 1080);
...
//	mods.tconstruct.Melting.addRecipe(<liquid:copper> * 20, <ore:oreMalachiteSmall>, 1080);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:gold> * 288, <immersiveengineering:sheetmetal:10>, 1060);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:gold> * 144, <ore:scrapGold>, 1060);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:pigiron> * 144, <ore:scrapPigIron>, 1535);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:iron> * 288, <immersiveengineering:sheetmetal:9>, 1535);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:iron> * 144, <ore:scrapWroughtIron>, 1535);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:iron> * 10, <ore:powderIron>, 1535);
...
//	mods.tconstruct.Melting.addRecipe(<liquid:iron> * 20, <ore:oreMagnetiteSmall>, 1535);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:iron> * 1440, <minecraft:minecart>, 1535);


	//Steel

	mods.tconstruct.Melting.addRecipe(<liquid:steel> * 2016, <tfc:metal/anvil/steel>, 1540);
	mods.tconstruct.Melting.addRecipe(<liquid:steel> * 288, <immersiveengineering:sheetmetal:8>, 1540);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:steel> * 144, <ore:scrapSteel>, 1540);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:platinum> * 144, <ore:scrapPlatinum>, 1730);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:brass> * 144, <ore:scrapBrass>, 930);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:zinc> * 144, <ore:scrapZinc>, 420);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:rose_gold> * 144, <ore:scrapRoseGold>, 960);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:bismuth_bronze> * 144, <ore:scrapBismuthBronze>, 985);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:blue_steel> * 144, <ore:scrapBlueSteel>, 1540);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:red_steel> * 144, <ore:scrapRedSteel>, 1540);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:black_bronze> * 144, <ore:scrapBlackBronze>, 1070);
	...
	mods.tconstruct.Melting.addRecipe(<liquid:black_steel> * 144, <ore:scrapBlackSteel>, 1485);
...
//Add Casting	
	...
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/ingot/antimony>, <tconstruct:cast_custom>, <liquid:antimony>, 144, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/ingot/mithril>, <tconstruct:cast_custom>, <liquid:mithril>, 144, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/ingot/invar>, <tconstruct:cast_custom>, <liquid:invar>, 144, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/ingot/aluminium>, <tconstruct:cast_custom>, <liquid:aluminum>, 144, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/ingot/aluminium_brass>, <tconstruct:cast_custom>, <liquid:alubrass>, 144, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/ingot/osmium>, <tconstruct:cast_custom>, <liquid:osmium>, 144, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/ingot/titanium>, <tconstruct:cast_custom>, <liquid:titanium>, 144, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/ingot/tungsten>, <tconstruct:cast_custom>, <liquid:tungsten>, 144, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/ingot/tungsten_steel>, <tconstruct:cast_custom>, <liquid:tungsten_steel>, 144, false, 40);
	...
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/aluminium>, <tconstruct:cast_custom:3>, <liquid:aluminum>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/ardite>, <tconstruct:cast_custom:3>, <liquid:ardite>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/cobalt>, <tconstruct:cast_custom:3>, <liquid:cobalt>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/constantan>, <tconstruct:cast_custom:3>, <liquid:constantan>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/electrum>, <tconstruct:cast_custom:3>, <liquid:electrum>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/manyullyn>, <tconstruct:cast_custom:3>, <liquid:manyullyn>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/antimony>, <tconstruct:cast_custom:3>, <liquid:antimony>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/mithril>, <tconstruct:cast_custom:3>, <liquid:mithril>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/invar>, <tconstruct:cast_custom:3>, <liquid:invar>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/aluminium>, <tconstruct:cast_custom:3>, <liquid:aluminum>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/aluminium_brass>, <tconstruct:cast_custom:3>, <liquid:alubrass>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/osmium>, <tconstruct:cast_custom:3>, <liquid:osmium>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/titanium>, <tconstruct:cast_custom:3>, <liquid:titanium>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/tungsten>, <tconstruct:cast_custom:3>, <liquid:tungsten>, 288, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sheet/tungsten_steel>, <tconstruct:cast_custom:3>, <liquid:tungsten_steel>, 288, false, 80);

	//Golden Foodstuffs
	mods.tconstruct.Casting.addTableRecipe(<minecraft:golden_carrot>, <ore:carrot>, <liquid:gold>, 1296, true, 2000);
	mods.tconstruct.Casting.addTableRecipe(<minecraft:golden_apple:0>, <ore:apple>, <liquid:gold>, 1296, true, 2000);
...
//Add Alloys	
	...
	mods.tconstruct.Alloy.addRecipe(<liquid:red_steel> * 9, [<liquid:black_steel> * 5, <liquid:rose_gold> * 1, <liquid:brass> * 1, <liquid:steel> * 2]);
	mods.tconstruct.Alloy.addRecipe(<liquid:blue_steel> * 9, [<liquid:black_steel> * 5, <liquid:bismuth_bronze> * 1, <liquid:sterling_silver> * 1, <liquid:steel> * 2]);
	...
	mods.tconstruct.Alloy.addRecipe(<liquid:black_bronze> * 5, [<liquid:electrum> * 2, <liquid:copper> * 3]);
	mods.tconstruct.Alloy.addRecipe(<liquid:rose_gold> * 5, [<liquid:gold> * 4, <liquid:copper> * 1]);
	mods.tconstruct.Alloy.addRecipe(<liquid:sterling_silver> * 10, [<liquid:silver> * 7, <liquid:copper> * 3]);
	mods.tconstruct.Alloy.addRecipe(<liquid:bismuth_bronze> * 5, [<liquid:brass> * 4, <liquid:bismuth> * 1]);
	mods.tconstruct.Alloy.addRecipe(<liquid:mithril> * 10, [<liquid:copper> * 9, <liquid:antimony> * 1]);
	mods.tconstruct.Alloy.addRecipe(<liquid:tungsten_steel> * 5, [<liquid:tungsten> * 1, <liquid:steel> * 4]);
...
//Add Casting to Table Recipes	
	...
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/pick_head/mithril>, <tfc:ceramics/fired/mold/pick_head>, <liquid:mithril>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/pick_head/invar>, <tfc:ceramics/fired/mold/pick_head>, <liquid:invar>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/pick_head/aluminium>, <tfc:ceramics/fired/mold/pick_head>, <liquid:aluminium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/pick_head/cobalt>, <tfc:ceramics/fired/mold/pick_head>, <liquid:cobalt>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/pick_head/manyullyn>, <tfc:ceramics/fired/mold/pick_head>, <liquid:manyullyn>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/pick_head/osmium>, <tfc:ceramics/fired/mold/pick_head>, <liquid:osmium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/pick_head/titanium>, <tfc:ceramics/fired/mold/pick_head>, <liquid:titanium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/pick_head/tungsten>, <tfc:ceramics/fired/mold/pick_head>, <liquid:tungsten>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/pick_head/tungsten_steel>, <tfc:ceramics/fired/mold/pick_head>, <liquid:tungsten_steel>, 100, false, 40);
	...
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/shovel_head/mithril>, <tfc:ceramics/fired/mold/shovel_head>, <liquid:mithril>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/shovel_head/invar>, <tfc:ceramics/fired/mold/shovel_head>, <liquid:invar>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/shovel_head/aluminium>, <tfc:ceramics/fired/mold/shovel_head>, <liquid:aluminium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/shovel_head/cobalt>, <tfc:ceramics/fired/mold/shovel_head>, <liquid:cobalt>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/shovel_head/manyullyn>, <tfc:ceramics/fired/mold/shovel_head>, <liquid:manyullyn>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/shovel_head/osmium>, <tfc:ceramics/fired/mold/shovel_head>, <liquid:osmium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/shovel_head/titanium>, <tfc:ceramics/fired/mold/shovel_head>, <liquid:titanium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/shovel_head/tungsten>, <tfc:ceramics/fired/mold/shovel_head>, <liquid:tungsten>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/shovel_head/tungsten_steel>, <tfc:ceramics/fired/mold/shovel_head>, <liquid:tungsten_steel>, 100, false, 40);
	...
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/axe_head/mithril>, <tfc:ceramics/fired/mold/axe_head>, <liquid:mithril>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/axe_head/invar>, <tfc:ceramics/fired/mold/axe_head>, <liquid:invar>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/axe_head/aluminium>, <tfc:ceramics/fired/mold/axe_head>, <liquid:aluminium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/axe_head/cobalt>, <tfc:ceramics/fired/mold/axe_head>, <liquid:cobalt>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/axe_head/manyullyn>, <tfc:ceramics/fired/mold/axe_head>, <liquid:manyullyn>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/axe_head/osmium>, <tfc:ceramics/fired/mold/axe_head>, <liquid:osmium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/axe_head/titanium>, <tfc:ceramics/fired/mold/axe_head>, <liquid:titanium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/axe_head/tungsten>, <tfc:ceramics/fired/mold/axe_head>, <liquid:tungsten>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/axe_head/tungsten_steel>, <tfc:ceramics/fired/mold/axe_head>, <liquid:tungsten_steel>, 100, false, 40);
	...
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hoe_head/mithril>, <tfc:ceramics/fired/mold/hoe_head>, <liquid:mithril>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hoe_head/invar>, <tfc:ceramics/fired/mold/hoe_head>, <liquid:invar>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hoe_head/aluminium>, <tfc:ceramics/fired/mold/hoe_head>, <liquid:aluminium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hoe_head/cobalt>, <tfc:ceramics/fired/mold/hoe_head>, <liquid:cobalt>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hoe_head/manyullyn>, <tfc:ceramics/fired/mold/hoe_head>, <liquid:manyullyn>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hoe_head/osmium>, <tfc:ceramics/fired/mold/hoe_head>, <liquid:osmium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hoe_head/titanium>, <tfc:ceramics/fired/mold/hoe_head>, <liquid:titanium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hoe_head/tungsten>, <tfc:ceramics/fired/mold/hoe_head>, <liquid:tungsten>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hoe_head/tungsten_steel>, <tfc:ceramics/fired/mold/hoe_head>, <liquid:tungsten_steel>, 100, false, 40);
	...
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/chisel_head/mithril>, <tfc:ceramics/fired/mold/chisel_head>, <liquid:mithril>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/chisel_head/invar>, <tfc:ceramics/fired/mold/chisel_head>, <liquid:invar>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/chisel_head/aluminium>, <tfc:ceramics/fired/mold/chisel_head>, <liquid:aluminium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/chisel_head/cobalt>, <tfc:ceramics/fired/mold/chisel_head>, <liquid:cobalt>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/chisel_head/manyullyn>, <tfc:ceramics/fired/mold/chisel_head>, <liquid:manyullyn>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/chisel_head/osmium>, <tfc:ceramics/fired/mold/chisel_head>, <liquid:osmium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/chisel_head/titanium>, <tfc:ceramics/fired/mold/chisel_head>, <liquid:titanium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/chisel_head/tungsten>, <tfc:ceramics/fired/mold/chisel_head>, <liquid:tungsten>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/chisel_head/tungsten_steel>, <tfc:ceramics/fired/mold/chisel_head>, <liquid:tungsten_steel>, 100, false, 40);
	
	//Sword
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/bismuth_bronze>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:bismuth_bronze>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/black_bronze>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:black_bronze>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/bronze>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:bronze>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/copper>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:copper>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/wrought_iron>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:iron>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/steel>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:steel>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/black_steel>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:black_steel>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/blue_steel>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:blue_steel>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/red_steel>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:red_steel>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/mithril>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:mithril>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/invar>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:invar>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/aluminium>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:aluminium>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/cobalt>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:cobalt>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/manyullyn>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:manyullyn>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/osmium>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:osmium>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/titanium>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:titanium>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/tungsten>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:tungsten>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/sword_blade/tungsten_steel>, <tfc:ceramics/fired/mold/sword_blade>, <liquid:tungsten_steel>, 200, false, 80);
	
	//Mace
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/bismuth_bronze>, <tfc:ceramics/fired/mold/mace_head>, <liquid:bismuth_bronze>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/black_bronze>, <tfc:ceramics/fired/mold/mace_head>, <liquid:black_bronze>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/bronze>, <tfc:ceramics/fired/mold/mace_head>, <liquid:bronze>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/copper>, <tfc:ceramics/fired/mold/mace_head>, <liquid:copper>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/wrought_iron>, <tfc:ceramics/fired/mold/mace_head>, <liquid:iron>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/steel>, <tfc:ceramics/fired/mold/mace_head>, <liquid:steel>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/black_steel>, <tfc:ceramics/fired/mold/mace_head>, <liquid:black_steel>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/blue_steel>, <tfc:ceramics/fired/mold/mace_head>, <liquid:blue_steel>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/red_steel>, <tfc:ceramics/fired/mold/mace_head>, <liquid:red_steel>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/mithril>, <tfc:ceramics/fired/mold/mace_head>, <liquid:mithril>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/invar>, <tfc:ceramics/fired/mold/mace_head>, <liquid:invar>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/aluminium>, <tfc:ceramics/fired/mold/mace_head>, <liquid:aluminium>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/cobalt>, <tfc:ceramics/fired/mold/mace_head>, <liquid:cobalt>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/manyullyn>, <tfc:ceramics/fired/mold/mace_head>, <liquid:manyullyn>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/osmium>, <tfc:ceramics/fired/mold/mace_head>, <liquid:osmium>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/titanium>, <tfc:ceramics/fired/mold/mace_head>, <liquid:titanium>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/tungsten>, <tfc:ceramics/fired/mold/mace_head>, <liquid:tungsten>, 200, false, 80);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/mace_head/tungsten_steel>, <tfc:ceramics/fired/mold/mace_head>, <liquid:tungsten_steel>, 200, false, 80);
	...
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/saw_blade/mithril>, <tfc:ceramics/fired/mold/saw_blade>, <liquid:mithril>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/saw_blade/invar>, <tfc:ceramics/fired/mold/saw_blade>, <liquid:invar>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/saw_blade/aluminium>, <tfc:ceramics/fired/mold/saw_blade>, <liquid:aluminium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/saw_blade/cobalt>, <tfc:ceramics/fired/mold/saw_blade>, <liquid:cobalt>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/saw_blade/manyullyn>, <tfc:ceramics/fired/mold/saw_blade>, <liquid:manyullyn>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/saw_blade/osmium>, <tfc:ceramics/fired/mold/saw_blade>, <liquid:osmium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/saw_blade/titanium>, <tfc:ceramics/fired/mold/saw_blade>, <liquid:titanium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/saw_blade/tungsten>, <tfc:ceramics/fired/mold/saw_blade>, <liquid:tungsten>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/saw_blade/tungsten_steel>, <tfc:ceramics/fired/mold/saw_blade>, <liquid:tungsten_steel>, 100, false, 40);
	...
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/javelin_head/mithril>, <tfc:ceramics/fired/mold/javelin_head>, <liquid:mithril>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/javelin_head/invar>, <tfc:ceramics/fired/mold/javelin_head>, <liquid:invar>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/javelin_head/aluminium>, <tfc:ceramics/fired/mold/javelin_head>, <liquid:aluminium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/javelin_head/cobalt>, <tfc:ceramics/fired/mold/javelin_head>, <liquid:cobalt>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/javelin_head/manyullyn>, <tfc:ceramics/fired/mold/javelin_head>, <liquid:manyullyn>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/javelin_head/osmium>, <tfc:ceramics/fired/mold/javelin_head>, <liquid:osmium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/javelin_head/titanium>, <tfc:ceramics/fired/mold/javelin_head>, <liquid:titanium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/javelin_head/tungsten>, <tfc:ceramics/fired/mold/javelin_head>, <liquid:tungsten>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/javelin_head/tungsten_steel>, <tfc:ceramics/fired/mold/javelin_head>, <liquid:tungsten_steel>, 100, false, 40);
	...
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hammer_head/mithril>, <tfc:ceramics/fired/mold/hammer_head>, <liquid:mithril>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hammer_head/invar>, <tfc:ceramics/fired/mold/hammer_head>, <liquid:invar>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hammer_head/aluminium>, <tfc:ceramics/fired/mold/hammer_head>, <liquid:aluminium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hammer_head/cobalt>, <tfc:ceramics/fired/mold/hammer_head>, <liquid:cobalt>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hammer_head/manyullyn>, <tfc:ceramics/fired/mold/hammer_head>, <liquid:manyullyn>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hammer_head/osmium>, <tfc:ceramics/fired/mold/hammer_head>, <liquid:osmium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hammer_head/titanium>, <tfc:ceramics/fired/mold/hammer_head>, <liquid:titanium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hammer_head/tungsten>, <tfc:ceramics/fired/mold/hammer_head>, <liquid:tungsten>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/hammer_head/tungsten_steel>, <tfc:ceramics/fired/mold/hammer_head>, <liquid:tungsten_steel>, 100, false, 40);
	...
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/propick_head/mithril>, <tfc:ceramics/fired/mold/propick_head>, <liquid:mithril>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/propick_head/invar>, <tfc:ceramics/fired/mold/propick_head>, <liquid:invar>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/propick_head/aluminium>, <tfc:ceramics/fired/mold/propick_head>, <liquid:aluminium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/propick_head/cobalt>, <tfc:ceramics/fired/mold/propick_head>, <liquid:cobalt>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/propick_head/manyullyn>, <tfc:ceramics/fired/mold/propick_head>, <liquid:manyullyn>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/propick_head/osmium>, <tfc:ceramics/fired/mold/propick_head>, <liquid:osmium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/propick_head/titanium>, <tfc:ceramics/fired/mold/propick_head>, <liquid:titanium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/propick_head/tungsten>, <tfc:ceramics/fired/mold/propick_head>, <liquid:tungsten>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/propick_head/tungsten_steel>, <tfc:ceramics/fired/mold/propick_head>, <liquid:tungsten_steel>, 100, false, 40);
	...
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/knife_blade/mithril>, <tfc:ceramics/fired/mold/knife_blade>, <liquid:mithril>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/knife_blade/invar>, <tfc:ceramics/fired/mold/knife_blade>, <liquid:invar>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/knife_blade/aluminium>, <tfc:ceramics/fired/mold/knife_blade>, <liquid:aluminium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/knife_blade/cobalt>, <tfc:ceramics/fired/mold/knife_blade>, <liquid:cobalt>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/knife_blade/manyullyn>, <tfc:ceramics/fired/mold/knife_blade>, <liquid:manyullyn>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/knife_blade/osmium>, <tfc:ceramics/fired/mold/knife_blade>, <liquid:osmium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/knife_blade/titanium>, <tfc:ceramics/fired/mold/knife_blade>, <liquid:titanium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/knife_blade/tungsten>, <tfc:ceramics/fired/mold/knife_blade>, <liquid:tungsten>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/knife_blade/tungsten_steel>, <tfc:ceramics/fired/mold/knife_blade>, <liquid:tungsten_steel>, 100, false, 40);
	...
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/scythe_blade/mithril>, <tfc:ceramics/fired/mold/scythe_blade>, <liquid:mithril>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/scythe_blade/invar>, <tfc:ceramics/fired/mold/scythe_blade>, <liquid:invar>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/scythe_blade/aluminium>, <tfc:ceramics/fired/mold/scythe_blade>, <liquid:aluminium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/scythe_blade/cobalt>, <tfc:ceramics/fired/mold/scythe_blade>, <liquid:cobalt>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/scythe_blade/manyullyn>, <tfc:ceramics/fired/mold/scythe_blade>, <liquid:manyullyn>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/scythe_blade/osmium>, <tfc:ceramics/fired/mold/scythe_blade>, <liquid:osmium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/scythe_blade/titanium>, <tfc:ceramics/fired/mold/scythe_blade>, <liquid:titanium>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/scythe_blade/tungsten>, <tfc:ceramics/fired/mold/scythe_blade>, <liquid:tungsten>, 100, false, 40);
	mods.tconstruct.Casting.addTableRecipe(<tfc:metal/scythe_blade/tungsten_steel>, <tfc:ceramics/fired/mold/scythe_blade>, <liquid:tungsten_steel>, 100, false, 40);
	
//=======================================================================================================================================================================
//Drying Racks

	//Remove
	mods.jei.JEI.hide(<tconstruct:edible:0>);
	mods.jei.JEI.hide(<tconstruct:edible:10>);
	mods.jei.JEI.hide(<tconstruct:edible:11>);
	mods.jei.JEI.hide(<tconstruct:edible:12>);
	mods.jei.JEI.hide(<tconstruct:edible:13>);
	mods.jei.JEI.hide(<tconstruct:edible:14>);
	mods.jei.JEI.hide(<tconstruct:edible:15>);
	mods.jei.JEI.hide(<tconstruct:edible:20>);
	mods.jei.JEI.hide(<tconstruct:edible:21>);
	mods.jei.JEI.hide(<tconstruct:edible:22>);
	mods.jei.JEI.hide(<tconstruct:edible:23>);
	mods.jei.JEI.hide(<tconstruct:edible:30>);
	mods.jei.JEI.hide(<tconstruct:edible:31>);
	mods.jei.JEI.hide(<tconstruct:edible:32>);
	mods.jei.JEI.hide(<tconstruct:edible:33>);
	mods.jei.JEI.hide(<tconstruct:edible:34>);
	mods.tconstruct.Drying.removeRecipe(<tconstruct:edible:*>);
	
	//Add
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_beef>, <tfc:food/beef>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_fish>, <tfc:food/fish>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_gran_feline>, <tfc:food/gran_feline>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_mutton>, <tfc:food/mutton>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_pork>, <tfc:food/pork>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_camelidae>, <tfc:food/camelidae>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_venison>, <tfc:food/venison>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_poultry>, <tfc:food/chicken>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_fowl>, <tfc:food/pheasant>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_mongoose>, <tfc:food/mongoose>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_canine>, <tfc:food/wolf>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_rabbit>, <tfc:food/rabbit>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_bear_meat>, <tfc:food/bear>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_horse_meat>, <tfc:food/horse_meat>, 6000);
	mods.tconstruct.Drying.addRecipe(<contenttweaker:jerky_calamari>, <tfc:food/calamari>, 6000);
