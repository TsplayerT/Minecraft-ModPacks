...
# *======= Variables =======*
	...
	var ExtraArmorGroup = ArmorHandler.createArmorGroup("extra", 0.1);
...
# *======= Magical Armor =======*
	...
	magicalGroup.addArmor(ArmorHandler.createArmorSlot("head", <bewitchment:cold_iron_helmet>, 10, 0.15));
	magicalGroup.addArmor(ArmorHandler.createArmorSlot("chest", <bewitchment:cold_iron_chestplate>, 10, 0.15));
	magicalGroup.addArmor(ArmorHandler.createArmorSlot("legs", <bewitchment:cold_iron_leggings>, 10, 0.15));
	magicalGroup.addArmor(ArmorHandler.createArmorSlot("feet", <bewitchment:cold_iron_boots>, 10, 0.15));

	magicalGroup.addArmor(ArmorHandler.createArmorSlot("head", <galacticraftplanets:desh_helmet>, 10, 0.15));
	magicalGroup.addArmor(ArmorHandler.createArmorSlot("chest", <galacticraftplanets:desh_chestplate>, 10, 0.15));
	magicalGroup.addArmor(ArmorHandler.createArmorSlot("legs", <galacticraftplanets:desh_leggings>, 10, 0.15));
	magicalGroup.addArmor(ArmorHandler.createArmorSlot("feet", <galacticraftplanets:desh_boots>, 10, 0.15));
...
# *======= Armaduras Extras =======*
	...
	//HeavyDuty Armor
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("head", <galacticraftcore:steel_helmet>, 1, 0.025));
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("chest", <galacticraftcore:steel_chestplate>, 1, 0.025));
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("legs", <galacticraftcore:steel_leggings>, 1, 0.025));
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("feet", <galacticraftcore:steel_boots>, 1, 0.025));

	//Magnesium Armor
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("head", <extraplanets:magnesium_helmet>, 1, 0.2));
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("chest", <extraplanets:magnesium_chest>, 1, 0.2));
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("legs", <extraplanets:magnesium_legings>, 1, 0.2));
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("feet", <extraplanets:magnesium_boots>, 1, 0.2));

	//Cyberware Stuff
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("head", <cyberware:shades2>, 1, 0.1));
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("head", <cyberware:shades>, 1, 0.1));
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("chest", <cyberware:jacket>, 1, 0.1));
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("chest", <cyberware:trenchcoat>, 1, 0.1));
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("chest", <cyberware:jacket>, 1, 0.1));
	ExtraArmorGroup.addArmor(ArmorHandler.createArmorSlot("chest", <cyberware:jacket>, 1, 0.1));

	ExtraArmorGroup.addEntity(zombie);
	ExtraArmorGroup.addEntity(zombieStrong);
	ExtraArmorGroup.addEntity(zombieBoss);
	ExtraArmorGroup.addEntity(knight);
	ExtraArmorGroup.addEntity(husk);
	ExtraArmorGroup.addEntity(witherSkeleton);
	ExtraArmorGroup.addEntity(zombiePigman);
	ExtraArmorGroup.addEntity(zombieVillager);
...
# *======= Energy Armor =======*
	...
	energyGroup.addArmor(ArmorHandler.createArmorSlot("head", <ic2:nano_helmet:26>, 2, 0.05));
	energyGroup.addArmor(ArmorHandler.createArmorSlot("chest", <ic2:nano_chestplate:26>, 2, 0.05));
	energyGroup.addArmor(ArmorHandler.createArmorSlot("legs", <ic2:nano_leggings:26>, 2, 0.05));
	energyGroup.addArmor(ArmorHandler.createArmorSlot("feet", <ic2:nano_boots:26>, 2, 0.05));

	energyGroup.addArmor(ArmorHandler.createArmorSlot("head", <ic2:quantum_helmet:26>, 1, 0.01));
	energyGroup.addArmor(ArmorHandler.createArmorSlot("chest", <ic2:quantum_chestplate:26>, 1, 0.01));
	energyGroup.addArmor(ArmorHandler.createArmorSlot("legs", <ic2:quantum_leggings:26>, 1, 0.01));
	energyGroup.addArmor(ArmorHandler.createArmorSlot("feet", <ic2:quantum_boots:26>, 1, 0.01));
...
# *======= Skeleton Armor =======*
	...
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("head", <immersiveengineering:faraday_suit_head>, 5, 0.05));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("chest", <immersiveengineering:faraday_suit_chest>, 5, 0.05));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("legs", <immersiveengineering:faraday_suit_legs>, 5, 0.05));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("feet", <immersiveengineering:faraday_suit_feet>, 5, 0.05));

	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("head", <minecraft:diamond_helmet>, 2, 0.04));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("chest", <minecraft:diamond_chestplate>, 2, 0.04));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("legs", <minecraft:diamond_leggings>, 2, 0.04));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("feet", <minecraft:diamond_boots>, 2, 0.04));

	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("head", <twilightforest:fiery_helmet>, 5, 0.05));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("chest", <twilightforest:fiery_chestplate>, 5, 0.05));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("legs", <twilightforest:fiery_leggings>, 5, 0.05));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("feet", <twilightforest:fiery_boots>, 5, 0.05));
	...
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("head", <nuclearcraft:helm_boron>, 10, 0.2));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("chest", <nuclearcraft:chest_boron>, 10, 0.2));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("legs", <nuclearcraft:legs_boron>, 10, 0.2));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("feet", <nuclearcraft:boots_boron>, 10, 0.2));

	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("head", <nuclearcraft:helm_tough>, 8, 0.04));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("chest", <nuclearcraft:chest_tough>, 8, 0.04));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("legs", <nuclearcraft:legs_tough>, 8, 0.04));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("feet", <nuclearcraft:boots_tough>, 8, 0.04));
		
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("head", <nuclearcraft:helm_hard_carbon>, 4, 0.01));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("chest", <nuclearcraft:chest_hard_carbon>, 4, 0.01));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("legs", <nuclearcraft:legs_hard_carbon>, 4, 0.01));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("feet", <nuclearcraft:boots_hard_carbon>, 4, 0.01));

	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("head", <nuclearcraft:helm_boron_nitride>, 3, 0.001));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("chest", <nuclearcraft:chest_boron_nitride>, 3, 0.001));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("legs", <nuclearcraft:legs_boron_nitride>, 3, 0.001));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("feet", <nuclearcraft:boots_boron_nitride>, 3, 0.001));
	
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("head", <mysticalagriculture:inferium_helmet>, 10, 0.1));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("chest", <mysticalagriculture:inferium_chestplate>, 10, 0.1));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("legs", <mysticalagriculture:inferium_leggings>, 10, 0.1));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("feet", <mysticalagriculture:inferium_boots>, 10, 0.1));

	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("head", <mysticalagriculture:prudentium_helmet>, 7, 0.1));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("chest", <mysticalagriculture:prudentium_chestplate>, 7, 0.1));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("legs", <mysticalagriculture:prudentium_leggings>, 7, 0.1));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("feet", <mysticalagriculture:prudentium_boots>, 7, 0.1));
		
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("head", <mysticalagriculture:intermedium_helmet>, 5, 0.1));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("chest", <mysticalagriculture:intermedium_chestplate>, 5, 0.1));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("legs", <mysticalagriculture:intermedium_leggings>, 5, 0.1));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("feet", <mysticalagriculture:intermedium_boots>, 5, 0.1));

	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("head", <mysticalagriculture:superium_helmet>, 2, 0.1));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("chest", <mysticalagriculture:superium_chestplate>, 2, 0.1));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("legs", <mysticalagriculture:superium_leggings>, 2, 0.1));
	skeletonGroup.addArmor(ArmorHandler.createArmorSlot("feet", <mysticalagriculture:superium_boots>, 2, 0.1));
