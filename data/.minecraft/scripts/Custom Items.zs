...
blue_steel_planer.maxDamage = 6500;
...
wrought_iron_planer.maxDamage = 2200;
...
red_steel_planer.maxDamage = 6500;
...
blue_steel_planer_blade.maxDamage = 6500;
...
bronze_planer_blade.maxDamage = 1300;
...
copper_planer_blade.maxDamage = 600;
...
wrought_iron_planer_blade.maxDamage = 2200;
...
red_steel_planer_blade.maxDamage = 6500;
...
steel_planer_blade.maxDamage = 3300;
...
var jerky_beef = VanillaFactory.createItemFood("jerky_beef", 4);
jerky_beef.wolfFood = true;
jerky_beef.register();

var jerky_pork = VanillaFactory.createItemFood("jerky_pork", 4);
jerky_pork.wolfFood = true;
jerky_pork.register();

var jerky_poultry = VanillaFactory.createItemFood("jerky_poultry", 4);
jerky_poultry.wolfFood = true;
jerky_poultry.register();

var jerky_mutton = VanillaFactory.createItemFood("jerky_mutton", 4);
jerky_mutton.wolfFood = true;
jerky_mutton.register();

var jerky_fish = VanillaFactory.createItemFood("jerky_fish", 4);
jerky_fish.wolfFood = true;
jerky_fish.register();

var jerky_bear_meat = VanillaFactory.createItemFood("jerky_bear_meat", 4);
jerky_bear_meat.wolfFood = true;
jerky_bear_meat.register();

var jerky_calamari = VanillaFactory.createItemFood("jerky_calamari", 4);
jerky_calamari.wolfFood = true;
jerky_calamari.register();

var jerky_horse_meat = VanillaFactory.createItemFood("jerky_horse_meat", 4);
jerky_horse_meat.wolfFood = true;
jerky_horse_meat.register();

var jerky_fowl = VanillaFactory.createItemFood("jerky_fowl", 4);
jerky_fowl.wolfFood = true;
jerky_fowl.register();

var jerky_venison = VanillaFactory.createItemFood("jerky_venison", 4);
jerky_venison.wolfFood = true;
jerky_venison.register();

var jerky_canine = VanillaFactory.createItemFood("jerky_canine", 4);
jerky_canine.wolfFood = true;
jerky_canine.register();

var jerky_rabbit = VanillaFactory.createItemFood("jerky_rabbit", 4);
jerky_rabbit.wolfFood = true;
jerky_rabbit.register();

var jerky_mongoose = VanillaFactory.createItemFood("jerky_mongoose", 4);
jerky_mongoose.wolfFood = true;
jerky_mongoose.register();

var jerky_gran_feline = VanillaFactory.createItemFood("jerky_gran_feline", 4);
jerky_gran_feline.wolfFood = true;
jerky_gran_feline.register();

var jerky_camelidae = VanillaFactory.createItemFood("jerky_camelidae", 4);
jerky_camelidae.wolfFood = true;
jerky_camelidae.register();

//=====================================================================================================================================================================
//Magnetite Powder

var powder_magnetite = VanillaFactory.createItem("powder_magnetite");
powder_magnetite.maxStackSize = 64;
powder_magnetite.register();

//Crown

var unfinished_crown = VanillaFactory.createItem("unfinished_crown");
unfinished_crown.maxStackSize = 1;
unfinished_crown.register();